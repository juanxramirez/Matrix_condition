...
Figures showing the distribution of the matrix condition in low-risk and high-risk species globally (Suplementary Fig. 4) and at the scale of individual biogeopraphic realms (Supplementary Fig. 5). Requires data_high_medium_first_last.txt as input data.
